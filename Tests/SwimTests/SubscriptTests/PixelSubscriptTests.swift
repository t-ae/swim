...
class PixelSubscriptTests: XCTestCase {
    ...
    func testSubscriptGet() {
        do {
            ...
            // pixel
            XCTAssertEqual(image[0, 0], Color(gray: 0))
            XCTAssertEqual(image[1, 0], Color(gray: 1))
            XCTAssertEqual(image[0, 1], Color(gray: 4))
            XCTAssertEqual(image[1, 1], Color(gray: 5))
        ...
        do {
            ...
            // pixel
            XCTAssertEqual(image[0, 0], Color(r: 0, g: 1, b: 2, a: 3))
            XCTAssertEqual(image[1, 0], Color(r: 4, g: 5, b: 6, a: 7))
            XCTAssertEqual(image[0, 1], Color(r: 16, g: 17, b: 18, a: 19))
    ...
    func testSubscriptSet() {
        ...
        do {
            ...
            image[1, 0] = Color(r: 99, g: 98, b: 97, a: 96)
            XCTAssertEqual(image,
                           Image(width: 2, height: 2, data: [100, 1, 2, 3,
                                                             99, 98, 97, 96,
                                                             8, 9, 10, 11, 12,
