...
class CorrelationTests: XCTestCase {
    ...
    func testSSD() {
        ...
        do {
            let image1 = Image<Intensity, Double>(width: 3, height: 2, data: [0, 1, 2, 3, 4, 5])
            let image2 = Image<Intensity, Double>(width: 3, height: 2, data: [2, 4, 6, 2, 4, 6])
    ...
    func testZNCC() {
        ...
        do {
            ...
            let i1 = Image<Intensity, Double>(width: 3, height: 1, data: [0, 1, 0])
            let i2 = Image<Intensity, Double>(width: 3, height: 1, data: [1, 0, 1])
