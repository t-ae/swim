...
class ResizeTests: XCTestCase {
    func testResizeAA_upscale() {
        let image = Image<Intensity, Float>(width: 2, height: 2, data: [0, 1,
                                                                        2, 3])
        let resized3 = image.transform.resizeAA(width: 3, height: 3)
        XCTAssertEqual(resized3, Image(width: 3, height: 3, data: [0, 0.5, 1,
                                                                   1, 1.5, 2,
                                                                   2, 2.5, 3]),
                       accuracy: 1e-3)
        
        let resized4 = image.transform.resizeAA(width: 4, height: 4)
    ...
    func testResizeAA_downscale_separate() {
        ...
        let resizedX  = image.transform.resizeAA(width: 3, height: 4)
        ...
        let resizedY  = image.transform.resizeAA(width: 4, height: 3)
    ...
    func testResizeAA_downscale() {
        ...
        let resized2 = image.transform.resizeAA(width: 2, height: 2)
    ...
    func testResizeAA_separate() {
        ...
        let resized = image.transform.resizeAA(width: width, height: height)
        let resizedX = image.transform.resizeAA(width: width, height: image.height)
        let resizedY = image.transform.resizeAA(width: image.width, height: height)
        
        XCTAssertEqual(resizedX.transform.resizeAA(width: width, height: height), resized, accuracy: 1e-3)
        XCTAssertEqual(resizedY.transform.resizeAA(width: width, height: height), resized, accuracy: 1e-3)
    }
}
