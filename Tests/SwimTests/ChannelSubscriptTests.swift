...
class ChannelSubscriptTests: XCTestCase {
    ...
    func testChannelSubscriptSet() {
        ...
        XCTAssertEqual(image.data, [252, 1, 2, 3,
                                    253, 5, 6, 7,
                                    254, 9, 10, 11,
                                    255, 13, 14, 15])
        
        image[channel: .green] = newPixel
        XCTAssertEqual(image.data, [252, 252, 2, 3,
                                    253, 253, 6, 7,
                                    254, 254, 10, 11,
                                    255, 255, 14, 15])
        
        image[channel: 2] = newPixel
        XCTAssertEqual(image.data, [252, 252, 252, 3,
                                    253, 253, 253, 7,
                                    254, 254, 254, 11,
                                    255, 255, 255, 15])
        
        image[channel: .alpha] = newPixel
        XCTAssertEqual(image.data, [252, 252, 252, 252,
                                    253, 253, 253, 253,
                                    254, 254, 254, 254,
                                    255, 255, 255, 255])
        
        image[channel: .red][0, 0] = 0
        XCTAssertEqual(image.data, [0, 252, 252, 252,
                                    253, 253, 253, 253,
                                    254, 254, 254, 254,
                                    255, 255, 255, 255])
    }
