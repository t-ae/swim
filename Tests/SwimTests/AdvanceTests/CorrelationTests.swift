...
class CorrelationTests: XCTestCase {
    ...
    func testSSD() {
        do {
            ...
            XCTAssertEqual(ImageCompare.ssd(image1, image1), 0)
            XCTAssertEqual(ImageCompare.ssd(image1, image2), 31)
        }
        do {
    ...
    func testSAD() {
        do {
            ...
            XCTAssertEqual(ImageCompare.sad(image1, image1), 0)
            XCTAssertEqual(ImageCompare.sad(image1, image2), 11)
        }
        do {
            let image1 = Image(width: 3, height: 2, gray: [0, 1, 2, 3, 4, 5] as [Float])
            let image2 = Image(width: 3, height: 2, gray: [2, 4, 6, 2, 4, 6] as [Float])
    ...
    func testNCC() {
        do {
            ...
            XCTAssertEqual(ImageCompare.ncc(image1, image1), 1, accuracy: 1e-4)
            XCTAssertEqual(ImageCompare.ncc(image1, image2), ip / sqrt(l1 * l2), accuracy: 1e-4)
        }
        do {
        ...
        do {
            ...
            XCTAssertEqual(ImageCompare.ncc(image1, image2), 0)
        }
    }
    ...
    func testZNCC() {
        do {
            ...
            XCTAssertEqual(ImageCompare.zncc(image1, image1), 1, accuracy: 1e-4)
            
            let i1 = Image(width: 3, height: 1, gray: [0, 1, 0] as [Float])
            let i2 = Image(width: 3, height: 1, gray: [1, 0, 1] as [Float])
            
            XCTAssertEqual(ImageCompare.zncc(i1, i2), -1, accuracy: 1e-4)
        }
        do {
            let image1 = Image(width: 3, height: 2, gray: [0.0, 1, 2, 3, 4, 5])
        ...
        do {
            ...
            XCTAssertEqual(ImageCompare.zncc(image1, image2), 0)
        }
    }
    ...
    func testScale() {
        ...
        XCTAssertEqual(ImageCompare.ncc(image1, image2),
                       ImageCompare.ncc(image1/255, image2/255),
                       accuracy: 1e-3)
        XCTAssertEqual(ImageCompare.zncc(image1, image2),
                       ImageCompare.zncc(image1/255, image2/255),
                       accuracy: 1e-3)
    }
