...
extension Image where P == Intensity, T == Bool {
    ...
    public func converted(_ f: (Int, Int, Pixel<P, T>)->Pixel<IntensityAlpha, Bool>) -> Image<IntensityAlpha, Bool> {
        return _converted(f)
    }
    ...
    public func converted(_ f: (Int, Int, Pixel<P, T>)->Pixel<IntensityAlpha, UInt8>) -> Image<IntensityAlpha, UInt8> {
        return _converted(f)
    }
    ...
    public func converted(_ f: (Int, Int, Pixel<P, T>)->Pixel<IntensityAlpha, Int>) -> Image<IntensityAlpha, Int> {
        return _converted(f)
    }
    ...
    public func converted(_ f: (Int, Int, Pixel<P, T>)->Pixel<IntensityAlpha, Float>) -> Image<IntensityAlpha, Float> {
        return _converted(f)
    }
    ...
    public func converted(_ f: (Int, Int, Pixel<P, T>)->Pixel<IntensityAlpha, Double>) -> Image<IntensityAlpha, Double> {
        return _converted(f)
    }
