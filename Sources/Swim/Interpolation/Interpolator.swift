...
public protocol Interpolator {
    ...
    @inlinable func interpolate(x: Double, y: Double, in image: Image<P, T>) -> Pixel<P, T>
    @inlinable func interpolate(x: Double, y: Double, in image: Image<P, T>, into pixel: MutablePixelRef<P, T>)
}
